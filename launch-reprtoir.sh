...
helix_pane=$(wezterm cli spawn --cwd "$PROJECT_DIR")
lazygit_pane=$(wezterm cli spawn --cwd "$PROJECT_DIR")
foreman_pane=$(wezterm cli spawn --cwd "$PROJECT_DIR")
log_pane=$(wezterm cli spawn --cwd "$PROJECT_DIR")
sidekiq_pane=$(wezterm cli spawn --cwd "$PROJECT_DIR")
...
wezterm cli set-tab-title --pane-id "$helix_pane" "helix"
wezterm cli set-tab-title --pane-id "$lazygit_pane" "lazygit"
wezterm cli set-tab-title --pane-id "$foreman_pane" "foreman"
wezterm cli set-tab-title --pane-id "$log_pane" "rails logs"
wezterm cli set-tab-title --pane-id "$sidekiq_pane" "sidekiq"
